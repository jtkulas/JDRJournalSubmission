...
Perceptions of resources and demands, broadly, are not universal -- there are individual differences in how employees experience job characteristics. This finding aligns quite well with the challenge-hindrance stressor framework, which posits that employees perceive stimuli (i.e., job characteristics) uniquely (Lazarus and Folkman, 1984), and thus, could appraise them as either a challenge or hindrance to their job performance (Cavanaugh et al., 2000). Further, Cavanaugh et al. (2000) suggests that challenge demands are typically associated with positive outcomes and hindrance demands are associated with negative outcomes (e.g., Cavanaugh et al., 2000), which we partially supported here.
