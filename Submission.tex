...
While we have accumulated a vast literature on how job demands and resources relate to and influence key organizational outcomes, recent work has called into question some of our basic assumptions regarding the experience of demands in particular. We build on the work of a small, but growing number of researchers who argue that the work elements may be appraised simultaneously as resources and demands (Webster et al., 2011) or that appraisals may change over time (Rosen et al., 2020), with primary aims of exploring 1) whether there is variability in subjective ratings of job characteristics with respect to how much they serve as resources and demands, and 2) explore whether these subjective appraisals are differentially related to positive and negative outcomes. We utilize the O*Net database (\url{https://www.onetcenter.org/content.html}), which is the primary source of occupational information in the US, and as such, provides a rich source of information about occupational requirements (i.e., work activities and context) that may be rated in terms of level of demand or resource. We will refer to these as elements of working conditions throughout this paper (e.g., personal, contextual, or task-related conditions or elements of one's work).
...
The second set of analyses focuses on predicted associations without outcomes frequently studied across via job demands-resources Bakker and Demerouti (2017) and challenge-hindrance stressor framework Cavanaugh et al. (2000). Here, we specifically explore O*Net specified working condition apprasials as resources, challenges, and/or hindrances in association with engagement, strain and burnout. As argued above, appraisals are predicted to be associated with different forms of coping, and subsequently, outcomes. See Figure \ref{fig:ourmodel} for proposed associations.
