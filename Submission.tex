...
\hypertarget{the-job-demands-resources-theoryfoot2}{%
\subsection[The Job demands-Resources Theory]{\texorpdfstring{The Job demands-Resources Theory\footnote{Need to expand this section}}{The Job demands-Resources Theory}}\label{the-job-demands-resources-theoryfoot2}}
...
\textbf{Add information on Challenge-Hindrance stuff - it's in the SIOP submission so should be able to copy/paste}

\hypertarget{objective-vs.-subjective-nature-of-demands-and-resources-the-role-of-appraisalfoot3}{%
\subsection[Objective vs.~Subjective Nature of Demands and Resources: The Role of Appraisal]{\texorpdfstring{Objective vs.~Subjective Nature of Demands and Resources: The Role of Appraisal\footnote{Look for more recent literature - this is currently a bit dated}}{Objective vs.~Subjective Nature of Demands and Resources: The Role of Appraisal}}\label{objective-vs.-subjective-nature-of-demands-and-resources-the-role-of-appraisalfoot3}}
...
\hypertarget{study-1foot4}{%
\section[Study 1]{\texorpdfstring{Study 1\footnote{Need to delete all references to Study 1 and Study 2}}{Study 1}}\label{study-1foot4}}
...
\begin{quote}
\emph{Research Question 3}: Are literature-implicated hiderances consistently rated as job hinderances?
\end{quote}
