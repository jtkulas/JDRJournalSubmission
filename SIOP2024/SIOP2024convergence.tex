...
\emph{Paired samples t-tests for challenge/hindrance by item?} - I like this first idea. could present it by the 7 different categories.
\emph{Could look}
\emph{Or percent agreement?}
\emph{Maybe do item-level correlations between challenge/hindrance rating and present percent positively related, and negatively related (negative would be supportive, I think)}

The next question focuses on whether challenges (positive stressors per the definition above) might actually be positively related to resources. Per the job demands-resources theory (Bakker \& Demerouti, 2017) resources are defined as physical, psychological, social, or organizational aspects of the job that may help an employee achieve work goals, reduce job demands, or promote personal growth and development (Demerouti et al., 2001). It stands to reason that a challenging demand may be considered a resource.

\emph{RQ2}: Characteristics perceived as challenges are also commonly viewed as resources.
...
\emph{RQ3}: The association between challenging and resourceful characteristics is moderated by type of characteristic.
