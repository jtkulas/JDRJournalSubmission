...
H1 proposes that job characteristics differ in constancy regarding subjective worker perception as a demand or resource. We explore this hypothesis first by item, and then present a more holistic picture. First considering item-level characteristics, we present means and standard deviations visually, focusing on the items highest and lowest in variability. Figure \@ref(fig:combinegraphs) presents the top 8 resources, challenges, and hindrances characteristics that are *largely agreed on* as indexed by (relatively) low standard deviations.[^caveat] Note that the presentation is limited to 8 characteristics per perceived category only because of limited space. All sortable ratings are available in the online resources.
