...
The second set of analyses focuses on predicted associations without relevant work-relevant outcomes frequently studied across via job demands-resources- [@bakker2017job] and challenge-hindrance stressor-frameworks [@cavanaugh2000empirical]. Here, we specifically explore appraisals of O\*Net-derived work characteristics as resources, challenges, and/or hindrances in association with engagement, strain and burnout. As argued above, appraisals are predicted to be associated with different forms of coping, and subsequently, outcomes. See Figure \@ref(fig:ourmodel) for proposed associations. 
...
Both the job demands-resources model and the challenge-hindrance stressor framework have been associated with a wide variety of organizational outcomes ranging from affective variables like job satisfaction, to motivation commitment, and performance [e.g., @lepine2005meta]. We provide only a sampling of associated outcome examples here for context but note that the current project will focus on three outcomes: engagement, strain, and burnout. Beginning with resources, @hakanen2008job found job resources influenced future work engagement. Moreover, in a sample of teachers and dentists, @bakker2007job found that resources were most predictive of engagement when job demands were especially high. 
...
>Hypothesis 3b: Strain and burnout are differentially predicted by challenges and hindrances. **Take a look at significant difference between slope coefficients (b's) of, for example, challenge-->strain & hindrance-->strain**
