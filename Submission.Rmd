...
5. *Research Question 3*: Are literature-implicated hindrances consistently rated as job hindrances?
...
library(gridExtra)
grid.arrange(d, e, f, nrow = 3)

```

Figure \@ref(fig:combinegraphs2) presents the resources, challenges, and hindrances that are *largely disagreed on* as indexed by (relatively) high standard deviations (these are the 8 characteristics with the greatest variability in rating).
