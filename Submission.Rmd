...
Table 2 presents empirical  associations between estimates of resource, challenge, and hindrance and worker *engagement*, *stress*, and *burnout*. Here, workers' perceptions were aggregated across all characteristics to provide indications of "overall" resource and demand experience. Engagement exhibited non-trivial associations with all three types of perception whereas stress was only associated with the hindrance aggregate. The more percieved hindrances, the higher the rating of stress, indicating only weak partial support for Hypothesis 3b. All subsequent analyses retain this "overall" operationalization of workers' experience of resources, challenges, and hindrances. 
...
Hindrances exhibit greater variability, but a visual scan of the items reveals some with heavy physicality content (see, for example \@ref(fig:combinegraphs2)), perhaps reflecting some artificiality (for example, indicating "not terribly hindering" if the physical demand was not commonplace). 
