...
papaja::apa_table(regtable, 
              ...
              escape=FALSE,
              note="* = p < .05; ** = p < .01, coefficients are unstandardized and mean-centered")
```
