---
title             : "Shared Characterizations of Demands and Resources across O*NET Job Elements"
...
abstract: |
  Many discussions of job demands and resources include a tacit characterization that some job elements are resources and others are demands. This study documents variability in ratings of O\*Net job characteristics with respect to subjective interpretation of job characteristics, and further predicts the form of demand (challenge or hindrance) will exhibit differential association with work--related outcomes. We additionally explore the potential moderating role of resources on these relationships. The results indicate that job characteristics are not uniquely categorized as a resource or demand, but rather, some job characteristics are experienced both as resource and challenge. Resources moderated the challenge-engagement relationship, and further, also moderated the hindrance-stress, and hindrance-burnout relationships. These findings broadly suggest that challenging demands may also serve as job resources, and what is viewed as a hindrance exhibits considerable variability. These findings have implications for job design and management particularly with regard to the opportunity with demanding elements: these may be amenable to reframing as resources.
