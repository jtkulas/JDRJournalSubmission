...
Our model is represented in Figure \@ref(fig:ourmodel)
...
>Hyp 3.exploratory: More challenges leads to greater satisfaction, engagement, and burnout.[^figure]

[^figure]: These need to be reframed to match Figure 1.
