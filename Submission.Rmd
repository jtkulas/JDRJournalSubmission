...
## Standard deviations of perceptions
...
The effect for `Overwork` was `r report1$ANOVA$F`, partial eta squared was `r report1$ANOVA$pes`
The effect for `Physical Environment` was `r report2$ANOVA$F`, partial eta squared was `r report2$ANOVA$pes`
The effect for `Time Pressure` was `r report3$ANOVA$F`, partial eta squared was `r report3$ANOVA$pes`
The effect for `Emotional Demands` was `r report4$ANOVA$F`, partial eta squared was `r report4$ANOVA$pes`
The effect for `Recipient Contact` was `r report5$ANOVA$F`, partial eta squared was `r report5$ANOVA$pes`
The effect for `Work Pressure` was `r report6$ANOVA$F`, partial eta squared was `r report6$ANOVA$pes`
