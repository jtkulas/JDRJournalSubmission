...
The Job Demands-Resources Theory [JD-R; @demerouti2001job] has received wide support across contexts and varied research questions. We add to this literature via two routes: by utilizing some of the job characteristics in the popular O\*Net, and by focusing on perceptions of all characteristics as demands/resources. Specifically, we explore the interaction between perceptions of job demands and resources on the outcome of stress across a wide range of occupations. 

Here, respondents made a series of evaluations that used: direct O\*Net terminology (both descriptor and response option), and JD-R influenced ratings of demand and hindrance stressors. Prior to a description of results, a brief overview of both the JD-R theory, the stress appraisal process, and O\*Net, is provided. 
