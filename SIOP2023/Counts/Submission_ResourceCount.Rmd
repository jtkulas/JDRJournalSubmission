...
# Method
  ...
  We evaluate relationships between the predictors and proximal outcomes of the Job Demands-Resources model (Bakker & Demerouti, 2017; Bakker et al., 2003; @demerouti2001job), but from within the unifying framework of O\*Net. Here, we focus on the relationship between O\*Net delineated job components and employee levels of job engagement, job stress, and burnout with a U.S. workforce representative sample.
...
```{r correlation_table, eval=TRUE, include=FALSE}
