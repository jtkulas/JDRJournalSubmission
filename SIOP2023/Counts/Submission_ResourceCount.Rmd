...
```{r percagree, fig.cap="Percent convergence (characteristic rated consistently as, for example, both a resource and a hindrance."}
...
```{r recchall, fig.cap="Resource and challenge agreement across ONet characteristic groupings (e.g., scales)."}
