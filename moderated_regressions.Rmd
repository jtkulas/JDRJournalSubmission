...
cr_burn_m1 <- lm(burnout ~ overall.challenge_center, data = data)
summary(cr_burn_m1)

cr_burn_m2 <- lm(burnout ~ overall.challenge_center + overall.resource, data = data)
summary(cr_burn_m2)

cr_burn_m3 <- lm(burnout ~ overall.challenge_center + overall.resource_center + overall.challenge_center*overall.resource_center, data = data)
summary(cr_burn_m3)
...
cr_stress_m1 <- lm(stress ~ overall.challenge_center, data = data)
summary(cr_stress_m1)

cr_stress_m2 <- lm(stress ~ overall.challenge_center + overall.resource_center, data = data)
summary(cr_stress_m2)

cr_stress_m3 <- lm(stress ~ overall.challenge_center + overall.resource_center + overall.challenge_center*overall.resource_center, data = data)
summary(cr_stress_m3)

anova(cr_stress_m2, cr_stress_m3)
```

```{r Moderated Regression Challenge-Resource Engagement}

cr_eng_m1 <- lm(engagement ~ overall.challenge_center, data = data)
summary(cr_eng_m1)

cr_eng_m2 <- lm(engagement ~ overall.challenge_center + overall.resource_center, data = data)
summary(cr_eng_m2)

cr_eng_m3 <- lm(engagement ~ overall.challenge_center + overall.resource_center + overall.challenge_center*overall.resource_center, data = data)
summary(cr_eng_m3)

anova(cr_eng_m2, cr_eng_m3)
```

```{r Moderated Regression Hindrance-Resource Burnout}

hr_burn_m1 <- lm(burnout ~ overall.hindrance_center, data = data)
summary(hr_burn_m1)

hr_burn_m2 <- lm(burnout ~ overall.hindrance_center + overall.resource_center, data = data)
summary(hr_burn_m2)

hr_burn_m3 <- lm(burnout ~ overall.hindrance_center + overall.resource_center + overall.hindrance_center*overall.resource_center, data = data)
summary(hr_burn_m3)

anova(hr_burn_m2, hr_burn_m3)
```

```{r Moderated Regression Hindrance-Resource Stress}

hr_stress_m1 <- lm(stress ~ overall.hindrance_center, data = data)
summary(hr_stress_m1)

hr_stress_m2 <- lm(stress ~ overall.hindrance_center + overall.resource_center, data = data)
summary(hr_stress_m2)

hr_stress_m3 <- lm(stress ~ overall.hindrance_center + overall.resource_center + overall.hindrance_center*overall.resource_center, data = data)
summary(hr_stress_m3)

anova(hr_stress_m2, hr_stress_m3)
```

```{r Moderated Regression Hindrance-Resource Engagement}

hr_eng_m1 <- lm(engagement ~ overall.hindrance_center, data = data)
summary(hr_eng_m1)

hr_eng_m2 <- lm(engagement ~ overall.hindrance_center + overall.resource_center, data = data)
summary(hr_eng_m2)

hr_eng_m3 <- lm(engagement ~ overall.hindrance_center + overall.resource_center + overall.hindrance_center*overall.resource_center, data = data)
summary(hr_eng_m3)

anova(hr_eng_m2, hr_eng_m3)
```
...
b <- c(chal.2.eng, res.2.eng, int.cr.3.eng, chal.2.stress, res.2.stress, int.cr.3.stress, chal.2.burn, res.2.burn, int.cr.3.burn)
R2 <- c("", cr_eng_m2_r, cr_eng_m3_r, "", cr_stress_m2_r, cr_stress_m3_r, "", cr_burn_m2_r, cr_burn_m3_r)
DeltaR <- c("",paste(cr_eng_m2_r),cr_eng_r_square_change, "",paste(cr_stress_m2_r),cr_stress_r_square_change, "",paste(cr_burn_m2_r),cr_burn_r_square_change)

regtable <- cbind(DV, Step, Model, b, R2, DeltaR)
...
b <- c(hind.2.eng, res.2hr.eng, int.hr.3.eng, hind.2.stress, res.2hr.stress, int.hr.3.stress, hind.2.burn, res.2hr.burn, int.hr.3.burn)
