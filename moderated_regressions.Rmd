...
#r squared
hr_eng_m2_r <- round(summary(hr_eng_m2)$r.squared,2)
hr_eng_m3_r <- round(summary(hr_eng_m3)$r.squared,2)

## R square change
hr_eng_anova <- anova(hr_eng_m2, hr_eng_m3)
hr_eng_r_square_change <- round(hr_eng_m3_r - hr_eng_m2_r,2)
```
...
Beta <- c(hind.2.eng, res.2hr.eng, int.hr.3.eng, hind.2.stress, res.2hr.stress, int.hr.3.stress, hind.2.burn, res.2hr.burn, int.hr.3.burn)
R2 <- c("", hr_eng_m2_r, hr_eng_m3_r, "", hr_stress_m2_r, hr_stress_m3_r, "", hr_burn_m2_r, hr_burn_m3_r)
...
DeltaR <- c("","",hr_eng_r_square_change, "","",hr_stress_r_square_change, "","",hr_burn_r_square_change)
regtable <- cbind(DV, Step, Model, Beta, R2, DeltaR)
