...
Beta <- c(chal.2.eng, paste(res.2.eng,"**"), paste(int.cr.3.eng,"*"), chal.2.stress, res.2.stress, int.cr.3.stress, paste(chal.2.burn,"**"), res.2.burn, int.cr.3.burn)
...
#https://stackoverflow.com/questions/67088456/r-aligning-table-content-to-decimal-points-in-kable
