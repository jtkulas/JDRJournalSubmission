...
# b weights
chal.2.burn <- round(summary(challenge_resource_burnout_model2)$coefficients[2, 1],6)
res.2.burn <- round(summary(challenge_resource_burnout_model2)$coefficients[3, 1],6)

int.3.burn <- round(summary(challenge_resource_burnout_model3)$coefficients[4, 1],6)

#r squared
challenge_resource_burnout_model2_r <- round(summary(challenge_resource_burnout_model2)$r.squared,4)
challenge_resource_burnout_model3_r <- round(summary(challenge_resource_burnout_model3)$r.squared,4)


## R square change
challenge_resource_burnout_anova <- anova(challenge_resource_burnout_model2, challenge_resource_burnout_model3)
challenge_resource_burnout_r_square_change <- round(challenge_resource_burnout_model3_r - challenge_resource_burnout_model2_r,4)
...
b <- c(chal.2.burn,res.2.burn,int.3.burn)
DeltaR <- c("",paste(challenge_resource_burnout_model2_r,"**"),challenge_resource_burnout_r_square_change)
